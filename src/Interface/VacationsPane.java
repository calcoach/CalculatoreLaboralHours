...
public class VacationsPane extends javax.swing.JPanel {
    ...
    private void showData(VacationsInabilityCalculator cal) {
        ...
        model.addRow(new Object[]{new CalendarString(date1.getCalendar()).getStringDate(), new CalendarString(date1.getCalendar()).getStringDate(),
            cal.getRevenue()});
        jTable1.updateUI();
    ...
    private void saveRegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveRegistryActionPerformed
        ...
        if (verifiedRegistry.verifiedEntries()) {
            ...
            boolean rs = managingData.insertVacationsInability(new CalendarString(date1.getCalendar()).getStringDate(),
                    new CalendarString(date2.getCalendar()).getStringDate(), calc.getRevenue(), 1);
